...
bash rl_noise/text-to-sql/grpo_clean.sh --base_dir=/data/daniel_kang_group/rl_noise --run_name=sql_clean_qwen2.5_coder_7b_instruct --model=Qwen/Qwen2.5-Coder-7B-Instruct 
