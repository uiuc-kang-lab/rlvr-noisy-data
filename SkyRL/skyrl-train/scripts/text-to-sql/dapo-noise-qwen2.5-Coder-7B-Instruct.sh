...
bash rl_noise/text-to-sql/dapo_noise.sh --base_dir=/data/daniel_kang_group/rl_noise --run_name=dapo_sql_noise_qwen2.5_coder_7b_instruct --model=Qwen/Qwen2.5-Coder-7B-Instruct
