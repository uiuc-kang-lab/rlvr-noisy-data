...
bash rl_noise/text-to-sql/ppo_clean.sh --base_dir=/data/daniel_kang_group/rl_noise --run_name=ppo_sql_clean_qwen2.5_coder_7b_instruct --model=Qwen/Qwen2.5-Coder-7B-Instruct
