...
class Experience:
    ...
    additional_advantages: Optional[Float[torch.Tensor, "batch response_len"]] = None
    ...
    def to_device(self, device: torch.device) -> None:
        ...
        if self.additional_advantages is not None:
            self.additional_advantages = to(self.additional_advantages, device)
